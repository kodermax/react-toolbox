...
var factory = function factory(ripple, FontIcon) {
    ...
    _createClass(Button, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['accent', 'children', 'className', 'colorIcon', 'flat', 'floating', 'href', 'icon', 'inverse', 'label', 'mini', 'neutral', 'primary', 'theme', 'raised']);
        ...
        return _react2.default.createElement(element, props, icon ? _react2.default.createElement(FontIcon, { className: theme.icon, colorIcon: colorIcon, value: icon }) : null, label, children);
      }
    }]);
  ...
  Button.propTypes = {
    ...
    colorIcon: _react.PropTypes.string,
